...
const Watermark = dynamic(() => import('@/tools/image/watermark/Watermark'), {
  ssr: false,
});

const TOOL = getToolByHref('/tools/image/watermark')!;
...
export default function Page() {
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', flex: 1, minWidth: 0 }}>
      <Watermark title={TITLE} description={TOOL.description} />
