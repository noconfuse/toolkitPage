...
const BackgroundReplace = dynamic(
  () => import('@/tools/image/background-replace/BackgroundReplace'),
  { ssr: false },
);

const TOOL = getToolByHref('/tools/image/background-replace')!;
...
export default function Page() {
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', flex: 1, minWidth: 0 }}>
      <BackgroundReplace title={TITLE} description={TOOL.description} />
